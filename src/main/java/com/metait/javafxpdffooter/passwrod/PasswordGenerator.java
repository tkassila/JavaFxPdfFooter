package com.metait.javafxpdffooter.passwrod;
...
public class PasswordGenerator {
    ...
    public static String generateStrongPassword(int iPwdLen) {

        int iPwdLength = PASSWORD_LENGTH;
        if (iPwdLen > PASSWORD_LENGTH)
            iPwdLength = iPwdLen;
        StringBuilder result = new StringBuilder(iPwdLength);
        ...
        String strOther = generateRandomString(PASSWORD_ALLOW, iPwdLength - 8);
